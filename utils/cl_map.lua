globalBlips = {}
function tnexa.addBlip(a, b, c, d, e, f, g, h)
...
function tnexa.removeBlip(j)
    RemoveBlip(j)
end
function tnexa.removeBlipAtCoords(x,y,z) -- used to remove green house blips for everyone when purchased
...
local k = {}
function tnexa.setNamedBlip(l, a, b, c, d, e, f, g)
    tnexa.removeNamedBlip(l)
    k[l] = tnexa.addBlip(a, b, c, d, e, f, g)
    return k[l]
end
function tnexa.removeNamedBlip(l)
    if k[l] ~= nil then
        tnexa.removeBlip(k[l])
        k[l] = nil
    end
end
function tnexa.setGPS(a, b)
    SetNewWaypoint(a + 0.0001, b + 0.0001)
end
function tnexa.setBlipRoute(j)
    SetBlipRoute(j, true)
end
local m = {}
...
local p = {}
local q = {}
function tnexa.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    local I = {
...
function tnexa.setNamedMarker(l, a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    tnexa.removeNamedMarker(l)
    o[l] = tnexa.addMarker(a, b, c, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H)
    return o[l]
end
function tnexa.removeNamedMarker(l)
    if o[l] ~= nil then
        tnexa.removeMarker(o[l])
        o[l] = nil
    end
end
local J = {}
...
Citizen.CreateThread(
    function()
        while true do
            q = tnexa.getNearbyMarkers()
            Citizen.Wait(10000)
        end
    end
)
function tnexa.getNearbyMarkers()
    local N = {}
    local O = tnexa.getPlayerCoords()
    local P = 0
...
function tnexa.setArea(l, a, b, c, T, U)
...
function tnexa.createArea(l, W, T, U, X, Y, Z, _)
...
function tnexa.removeArea(l)
    if Q[l] then
        Q[l] = nil
    end
end
function tnexa.doesAreaExist(l)
    if Q[l] then
        return true
    end
    return false
...
RegisterCommand("nextblip",function()
    ...
    a4 = tnexa.addBlip(1103.9739990234, 211.95138549805, -49.440101623535, a5, 0, "Chips Cashier", 0.8, true)
end)
