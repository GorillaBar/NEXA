...
function containsMyName(args)
  local myName = string.lower(exports["nexa"]:getPlayerName(PlayerId()))
  local message = ""
  for i = 2, #args do
...
AddEventHandler("nexa:hideChat",function(flag)
  hideChat = flag
  if hideChat then
...
AddEventHandler("nexa:chatReduceOpacity", function(flag)
